...
public class HashingHelperTest {
  ...
  void testHashing() {
    ...
    // Test verification
    assertFalse(HashingHelper.verifySha521WithSalt("bye", hashed));
    assertTrue(HashingHelper.verifySha521WithSalt(str, hashed));
  ...
  void testVerification() {
    ...
    assertFalse(HashingHelper.verifySha521WithSalt("wrong", hash1));
    assertTrue(HashingHelper.verifySha521WithSalt(str1, hash1));
    ...
    assertFalse(HashingHelper.verifySha521WithSalt("false", hash2));
    assertTrue(HashingHelper.verifySha521WithSalt(str2, hash2));
